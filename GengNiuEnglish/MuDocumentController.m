...
- (void) createPageView: (int)number
{
    ...
    if (!found) {
        ...
        MuPageViewNormal *view=[[MuPageViewNormal alloc] initWithFrame:CGRectMake(number * width, 0, width-GAP, height) dialogCreator:self updater:self document:docRef page:number];
        [view setScale:scale];
