//
//  GNDownloadDatabase.m
//  GengNiuEnglish
//
//  Created by luzegeng on 16/5/10.
...
static GNDownloadDatabase *singleInstance = nil;

@implementation GNDownloadDatabase
{
...
-(id) init
{
    self = [super init];
    if(self){
        NSString* dbFilePath=[CommonMethod getPath:[NSString stringWithFormat:@"%@_user.sqlite",MONEWFOLDER]];
        queue = [FMDatabaseQueue databaseQueueWithPath:dbFilePath];
    }
    return self;
}

+(GNDownloadDatabase*) sharedInstance
{
